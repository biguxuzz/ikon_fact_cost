...
#Вставка
	...
	ЗаписьЖурналаРегистрации(
		...
		,
		,
		"Расширение ikon_cost применено успешно. Версия 0.1.0.58. Алгоритм: " + ?(ПараметрыДерева.ИспользоватьПакетнуюОбработку, "НОВЫЙ (итерация по уровням)", "СТАРЫЙ (рекурсивный)"));
#КонецВставки
