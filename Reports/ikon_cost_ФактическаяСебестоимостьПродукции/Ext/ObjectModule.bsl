...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
	...
	// что невозможно воспроизвести в пакетном режиме без глубокой модификации запроса.
	// Используем старый алгоритм для получения правильного результата.
	ПараметрыДереваСебестоимости.ИспользоватьПакетнуюОбработку = Ложь;
